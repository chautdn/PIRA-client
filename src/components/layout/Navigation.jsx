            ...
            <div className="hidden md:flex items-center gap-4 ml-2">
              ...
              {!user ? (
                ...
                <div className="flex items-center gap-3">
                  <Link to={ROUTES.DASHBOARD} className="text-gray-700 hover:text-primary-700 text-sm">Bảng Điều Khiển</Link>
                  <button onClick={() => setShowLogoutModal(true)} disabled={loading} className="bg-red-600 text-white hover:bg-red-700 px-3 py-2 rounded-md text-sm font-medium disabled:opacity-50">Đăng Xuất</button>
                </div>
              )}
            </div>
          </div>
