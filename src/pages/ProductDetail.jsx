...
export default function ProductDetail() {
  ...
  const handleAddToCart = () => {
    console.log('Add to cart:', {
      ...
      quantity,
      rentalType,
      selectedDates: rentalType === 'hour' ? [new Date().toISOString().split('T')[0]] : selectedDates,
      hours: rentalType === 'hour' ? selectedHours : 0,
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-1">
            ...
            >
              ...
              <div className="mb-8">
                <h4 className="font-bold text-gray-900 mb-4 text-lg">⏰ Loại thuê</h4>
              ...
              {rentalType === 'hour' && (
                <div className="mb-8">
                  <h4 className="font-bold text-gray-900 mb-4 text-lg">🕐 Số giờ thuê</h4>
                  <div className="flex items-center bg-gray-50 rounded-xl p-2">
                    <button
                      onClick={() => setSelectedHours(Math.max(4, selectedHours - 1))}
                    ...
                    <div className="flex-1 text-center">
                      <div className="text-2xl font-bold text-gray-900">{selectedHours}</div>
                    ...
                    {getDaysInMonth(currentMonth).map((day, index) => (
                      <button
                        ...
                        className={`
                          ...
                          ${!day ? 'invisible' : ''}
                          ${!isDateAvailable(day) ? 'text-gray-300 cursor-not-allowed' : 'hover:bg-gray-100'}
                          ${isDateSelected(day) ? 'bg-gradient-to-br from-green-500 to-blue-500 text-white shadow-lg transform scale-105' : ''}
                          ${isDateAvailable(day) && !isDateSelected(day) ? 'text-gray-700 hover:shadow-md' : ''}
                        `}
                      >
                        {day}
                      </button>
                ...
                >
                  <div className="text-center">
                    ...
                    <div className="text-sm text-gray-600 mt-2">
                      {rentalType === 'hour'
                        ? `${formatPrice(getRentalPrice())}đ × ${selectedHours}h × ${quantity} cái`
