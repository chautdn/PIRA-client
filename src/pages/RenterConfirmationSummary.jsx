    ...
    <div className="max-w-6xl mx-auto p-6">
      ...
      <div className="space-y-6">
        {subOrders?.map((subOrder) => {
          const confirmedProducts = subOrder.products.filter(p => p.status === 'CONFIRMED');
          const rejectedProducts = subOrder.products.filter(p => p.status === 'REJECTED');
          const pendingProducts = subOrder.products.filter(p => p.status === 'PENDING');
