...
import EarlyReturnRequestsSection from "../../components/owner/EarlyReturnRequestsSection";
...
const ActiveRentals = () => {
  ...
  const [activeTab, setActiveTab] = useState("rentals"); // 'rentals' or 'early-returns'
                        ...
                        <div className="flex items-start gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-4 flex items-center gap-4 text-xs text-gray-500">
                              ...
                              <span>
                                🔖 Mã phụ:{" "}
                                <strong>{rental.subOrderNumber}</strong>
                              </span>
                            </div>
                          </div>
                        </div>
